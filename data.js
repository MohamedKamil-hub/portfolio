...
const PORTFOLIO = {
  ...
  statusLines: [
    ...
    { label: "role",     value: "Infrastructure & Systems Technician", highlight: false },
  ...
  experience: [
    {
      ...
      tags:     ["Linux", "Ubuntu", "Debian", "Cisco", "Networking", "Troubleshooting", "CUPS", "ITSM", "Hardware", "Bash"],
      bullets: {
        en: [
          "On-site IT support for the Amazon-CEVA Logistics deployment in Ontigola - full maquetacion cycles across a 100+ workstation production-line network, replacing aged hardware with updated systems.",
          "Deployed and configured 20-30 workstations per shift: Debian servers, Ubuntu endpoints, thin clients, monitors, RF scanners, and label printers - verified network connectivity and production-line integration for each station.",
          "User creation and enrollment; static IP assignment, WiFi configuration and driver installation (WiFi adapters, printers) at warehouse scale.",
          "Team reduced per-station configuration time from 40 minutes to 10 minutes through process improvements.",
          "Printer configuration and troubleshooting (CUPS, device pairing, queue management) for 24/7 logistics operations where downtime directly impacts fulfilment.",
          ...
          "Post-maquetacion phase: hardware and software incident response, connectivity troubleshooting and asset labelling across the production-line network.",
          "Worked with Cisco network equipment (routers, switches) and physical cabling in a live production environment.",
        ],
        es: [
          "Soporte IT on-site en el despliegue Amazon-CEVA Logistics en Ontigola - ciclos completos de maquetacion sobre una red de produccion de 100+ workstations, sustituyendo hardware antiguo por equipos actualizados.",
          "Despliegue y configuracion de 20-30 workstations por turno: servidores Debian, endpoints Ubuntu, thin clients, monitores, pistolas RF e impresoras de etiquetas - verificacion de conectividad e integracion con linea de produccion.",
          "Creacion y enrolado de usuarios; asignacion de IPs fijas, configuracion WiFi e instalacion de drivers (adaptadores WiFi, impresoras) a escala de almacen.",
          "El equipo redujo el tiempo de configuracion por estacion de 40 minutos a 10 minutos mediante mejoras de proceso.",
          "Configuracion y resolucion de incidencias de impresoras (CUPS, emparejamiento, gestion de cola) en operaciones logisticas 24/7 donde el downtime impacta directamente al fulfillment.",
          "Triaje de tickets ITSM bajo SLA: clasificacion remota vs presencial, reduciendo desplazamientos innecesarios de ingenieros.",
          "Fase post-maquetacion: respuesta a incidencias de hardware y software, troubleshooting de conectividad y etiquetado de activos en la red de produccion.",
          "Trabajo con equipamiento de red Cisco (routers, switches) y cableado fisico en entorno de produccion real.",
        ]
      }
    },
    {
      ...
      modality: { en: "Remote -  internship",      es: "Remoto - Practicas" },
...
Escribir una herramienta de monitorizacion en Go me obligo a aprender goroutines, channels y lectura de recursos a nivel syscall. El sistema de archivos \`/proc\` es sorprendentemente rico.
  ...
  i18n: {
    en: {
      ...
      "hero.role":       "Infrastructure & Systems Technician",
      "hero.bio":        "Infrastructure and systems work on Linux. Built a production WireGuard management panel from scratch during my last internship - FastAPI, Python and Bash on a 512 MB VPS. 40 simultaneous clients, under 50 ms latency. Currently doing on-site IT support at Randstad Digital on the Amazon-CEVA Logistics deployment in Ontigola. Open to roles where I can keep working on real Linux infrastructure.",
    ...
    es: {
      ...
      "hero.home":       "whoami",
      "hero.greeting":   "whoami",
      "hero.role":       "Tecnico de Infraestructura y Sistemas",
      "hero.bio":        "Infraestructura y sistemas sobre Linux. Construi un panel de gestion WireGuard en produccion desde cero durante mis ultimas practicas - FastAPI, Python y Bash en un VPS de 512 MB. 40 clientes simultaneos, menos de 50 ms de latencia. Actualmente en soporte IT on-site en Randstad Digital, en el despliegue Amazon-CEVA Logistics en Ontigola. Abierto a roles donde seguir trabajando con infraestructura Linux real.",
